    ...
    return (
        ...
        <div className="news_item accordion">
            ...
            <div className="accordion-item">
                ...
                <label className="accordion-item-trigger" for="accordion-1">
            ...
            <div className="accordion-item">
                ...
                <label className="accordion-item-trigger" for="accordion-2">
            ...
            <div className="accordion-item">
                ...
                <label className="accordion-item-trigger overflow" for="accordion-3">
                    <span className="accordion-theme">TRAVEL</span>
